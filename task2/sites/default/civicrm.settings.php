...
if (!defined('CIVICRM_UF_DSN') && CIVICRM_UF !== 'UnitTests') {
  define( 'CIVICRM_UF_DSN'           , 'mysql://root:@localhost/compucorpt2?new_link=true');
}
...
$civicrm_root = 'C:/wamp/www/compucorp/task2/sites/all/modules/civicrm';
if (!defined('CIVICRM_TEMPLATE_COMPILEDIR')) {
  define( 'CIVICRM_TEMPLATE_COMPILEDIR', 'C:/wamp/www/compucorp/task2\\sites\\default\\files\\civicrm\\templates_c\\');
}
...
if (!defined('CIVICRM_UF_BASEURL')) {
  define( 'CIVICRM_UF_BASEURL'      , 'http://localhost:8000/');
}
...
if (!defined('CIVICRM_SITE_KEY')) {
  define( 'CIVICRM_SITE_KEY', '3b65fe559656897aceefac36c68699c5');
}
...
// define( 'CIVICRM_MAIL_LOG', 'C:/wamp/www/compucorp/task2\\sites\\default\\files\\civicrm\\templates_c\\/mail.log');
// }
